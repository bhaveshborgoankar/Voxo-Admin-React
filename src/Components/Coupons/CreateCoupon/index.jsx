                ...
                <Card>
                  <CardBody>
                    <ul class='nav nav-pills mb-3' id='pills-tab' role='tablist'>
                      ...
                      <li class='nav-item' role='presentation'>
                        <button class='nav-link' id='pills-usage-tab' data-bs-toggle='pill' data-bs-target='#pills-usage' type='button'>
                          Usage
                        </button>
                      </li>
                    </ul>
                            ...
                            <div class='mb-4 row align-items-center'>
                              ...
                              <div class='col-md-9'>
                                <div class='form-check user-checkbox ps-0'>
                                  ...
                                  <label class='form-label-title col-md-2 mb-0'>Allow Free Shipping</label>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class='row align-items-center'>
                              ...
                              <div class='col-md-9'>
                                <div class='form-check user-checkbox ps-0'>
                                  ...
                                  <label class='form-label-title col-md-2 mb-0'>Enable the Coupon</label>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class='tab-pane fade' id='pills-profile' role='tabpanel'>
                        <form class='theme-form theme-form-2 mega-form'>
                          ...
                          <div class='row'>
                            ...
                            <div class='mb-4 row align-items-center'>
                              <label class='col-lg-2 col-md-3 col-form-label form-label-title'>Minimum Spend</label>
                              <div class='col-md-9 col-lg-10'>
                                <input class='form-control' type='number' />
                              </div>
                            </div>
                            ...
                            <div class='row align-items-center'>
                              <label class='col-lg-2 col-md-3 col-form-label form-label-title'>Maximum Spend</label>
                              <div class='col-md-9 col-lg-10'>
                                <input class='form-control' type='number' />
                              </div>
                            </div>
