...
import MainImage from '../../assets/images/logo/logo.png';
import whiteImage from '../../assets/images/logo/logo-white.png';
      ...
      <Row className='header-wrapper m-0'>
        <div className='header-logo-wrapper col-auto p-0'>
          <div className='logo-wrapper'>
            <a href='#javascript'>
              <img className='img-fluid main-logo' src={MainImage} alt='logo' />
              <img className='img-fluid white-logo' src={whiteImage} alt='logo' />
            </a>
          </div>
